...
function DrBrotoApp() {
  ...
  const handleAnalyzeImage = async () => {
    ...
    try {
      const response = await ImageAnalysisService.analyzeImage(selectedFile);
      setAnalysisResponse(response.result);
    } catch (error) {
      console.error('Erro ao analisar imagem', error);
      alert('Ocorreu um erro ao analisar a imagem. Por favor, tente novamente.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="app-container">
      ...
      <footer className="app-footer">
        <a 
          href="https://github.com/henriquespecian/dr-broto" 
          target="_blank" 
